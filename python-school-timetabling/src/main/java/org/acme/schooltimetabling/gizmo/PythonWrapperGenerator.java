...
public class PythonWrapperGenerator {
    ...
    private static final Map<Long, Object> pointerToClassInstance = new HashMap<>();
    ...
    public static Class<?> defineConstraintProviderClass(String className, Function<ConstraintProvider, Constraint[]> defineConstraintsImpl) {
        ...
        try(ClassCreator classCreator = ClassCreator.builder()
                ...
                .build()) {
            valueField = classCreator.getFieldCreator("__defineConstraintsImpl", Value.class)
            ...
            ResultHandle args = methodCreator.newArray(Object.class, 1);
            methodCreator.writeArrayValue(args, 0, methodCreator.getMethodParam(0));
            ResultHandle pythonMethod = methodCreator.readStaticField(valueField);
            ResultHandle resultValue = methodCreator.invokeVirtualMethod(MethodDescriptor.ofMethod(Value.class, "execute", Value.class, Object[].class),
                    pythonMethod, args);
            ResultHandle constraints = methodCreator.invokeVirtualMethod(MethodDescriptor.ofMethod(Value.class, "as", Object.class, Class.class),
                    resultValue, methodCreator.loadClass(Constraint[].class));
        ...
        try {
            ...
            out.getField(valueField.getName()).set(null, Value.asValue(defineConstraintsImpl));
            return out;
